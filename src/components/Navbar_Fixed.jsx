...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    const handleClickOutside = (event) => {
      ...
      // Mobile menu click outside is handled separately by backdrop onClick
      // We don't want to close mobile menu here to avoid conflicts
    };

    const handleScroll = () => {
      const currentScrollY = window.scrollY;
      // Only hide navbar on scroll down after scrolling more than 100px
        ...
        {menuOpen && (
          <div className="md:hidden">
            ...
            <motion.div
              ...
              className="fixed inset-0 top-0 z-[9998] bg-black/70 backdrop-blur-sm"
              onClick={closeMenu}
              style={{
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 z-[9999] w-80 max-w-[90vw]"
