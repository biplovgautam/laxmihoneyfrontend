      ...
      <div className="container py-14">
        ...
        {ProductsData.map((item) => (
          ...
          <motion.div
            ...
            initial="hidden"
            whileInView={"show"}
            className="flex flex-col items-center justify-center p-5 w-[300px] mx-auto shadow-lg rounded-xl bg-customorangelight2 h-[380px] transform transition duration-300 group-hover:scale-120 group-hover:bg-customorangelight"
          >
            <img
              src={item.image}
              alt=""
              className="w-[100px] mb-4 group-hover:rotate-12 group-hover:scale-120 duration-300"
            />
