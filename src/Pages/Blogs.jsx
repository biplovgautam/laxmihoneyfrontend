    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-600 via-orange-500 to-amber-500 relative overflow-hidden">
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Discover the world of pure honey, bee farming, and natural wellness through our carefully curated articles and insights.
          </motion.p>
      ...
      >
        <div className="container mx-auto px-4 py-8">
          {/* Glass morphism container for blogs */}
